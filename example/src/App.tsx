      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={{flex: 1, justifyContent: 'space-between', width: '100%'}}>
          ...
          <View style={styles.results}>
            {code != null && <Result code={code} description={description} />}
          </View>
          <View>
            <View style={styles.inputsTopGutter}>
              <Input placeholder="Session ID" value={sessionID} onChangeText={setSessionID} />
              <InputSpacer />
              <Input
            ...
            <View style={styles.yotiButton}>
              <Button
                onPress={() => {
                  RNYotiDocScan.start(sessionID, sessionToken, (resultCode, resultDescription) => {
                    setCode(resultCode);
...
function Result({code, description}: ResultProps) {
  ...
  return (
    <View style={styles.resultsContainer}>
      <View
        ...
        <Text style={styles.resultsHeaderText}>{isSuccessOutcome ? 'Success' : 'Error'}</Text>
      </View>
